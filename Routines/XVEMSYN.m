XVEMSYN ;V4W/DLW - Syntax highlighting ;2019-06-19  11:04 AM
...
SYNTAX(XVBUFFER,XVBUFNUM,XVW) ;Build a syntax structure for a corresponding line
 ...
 S (XVDATA("ARG"),XVDATA("FUNC"),XVDATA("STRING"),XVDATA("TAG"),XVDATA,XVEXT)=0
...
COMMAND ;Command state
 ...
 I XVDATA("CMD")="",XVUCHAR="T" S XVDATA("CMD")="TC[OMMIT]|TRE[START]|TRO[LLBACK]|TS[TART]" W:XVFLAG $$CONTROL("CMD") W:XVDATA'<XVW XVCHAR G COMMAND
 ...
 I $E(XVDATA("CMD"),1)="Z",$L(XVDATA("CMD"))=1,XVUCHAR=" "!(XVUCHAR=$C(9))!(XVUCHAR=":") W:XVDATA'<XVW $$CONTROL("ERR"),XVCHAR G ERROR
...
ARGUMENT ;Argument state
 ...
 I XVDATA("ARG")=0,XVCHAR="""" S XVDATA("STRING")=1 W:XVDATA'<XVW $$CONTROL("STR"),XVCHAR G STRING
 I XVDATA("ARG")=0,XVCHAR?1N W:XVDATA'<XVW $$CONTROL("NUM"),XVCHAR G NUMBER
 ...
 I XVCHAR=" " S XVDATA("ARG")=0,XVDATA("CMD")="" W:XVDATA'<XVW $$CONTROL("CMD"),XVCHAR G COMMAND
...
PUNCMARK ;Punctuation mark state
 ...
 I XVDATA("CMD")="TAG",XVDATA("TAG")=0,XVCHAR?1(1"%",1".") S (XVDATA("TAG"),XVDATA("ARG"))=1 W:XVDATA'<XVW $$CONTROL("ARG"),XVCHAR G ARGUMENT
...
STRING ;String state
 ...
 I XVCHAR="""" S XVDATA("STRING")=0 W:XVDATA'<XVW $$CONTROL("STR"),XVCHAR G ARGUMENT

XVEMKDT ; DJB/KRN ; DATE/TIME ; JUL 09, 2019@16:12
 ;;15.1;VICTORY PROG ENVIRONMENT;;Jun 19, 2019
 ; Original Code authored by David J. Bolduc 1985-2005
 ;
 ; DATE Type 4 (c) Sam Habiel 2019
 ;
 W !!?1,"Calling points: S DATE=$$DATE^XVEMKDT(1|2|3|4)"
 W !?1,"                S FMDATE=$$FMDATE^XVEMKDT()"
 W !?1,"                S TIME=$$TIME^XVEMKDT(1|2|3)",!
 Q
DATE(TYPE) ;TYPE=1 20-MAY-95   TYPE=2 3/5/95  TYPE=3 03/05/95  TYPE=4 MAY 20, 1995
 NEW DATE,DAY,H,I,LEAPYR,MONTH,MONTHNAM,R,YR
 S:",1,2,3,4,"'[(","_$G(TYPE)_",") TYPE=1
 ...
 I TYPE=4 D  S DATE=$P(MONTHNAM," ",MONTH)_" "_DAY_", "_YR
 . I $L(DAY)=1 S DAY=0_DAY
 Q DATE
